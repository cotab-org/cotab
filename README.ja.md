...
高い指示追従性能とQwen3-4B-Instruct-2507よりも少ないVRAMで動作しますが、Cotabにおいてはしばしば品質の悪い補完を生成するため、非推奨となっています。

- LFM2-2.6B

わずかVRAM 3GBの使用量で、Qwen3-4B-Instruct-2507よりも倍以上高速に動作するように設計されています。それにもかかわらず高い指示追従性能を持っていますが、Cotabのコード補完においてはコードが壊れる問題が散見されたため、非推奨となっています。VRAM要件が非常に厳しい場合や翻訳用途で利用できます。
